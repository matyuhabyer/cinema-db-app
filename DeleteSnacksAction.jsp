...
<head>
    ...
    <title>Delete Snacks Action</title>
</head>
<body>
    <center>
        <%
            ...
            if (snacksIDStr != null && !snacksIDStr.isEmpty()) {
                try {
                    int snacksID = Integer.parseInt(snacksIDStr);
                    ...
                    boolean deleted = snacks.deleteSnacks(connection, snacksID);
                
                    if (deleted) {
        %>
                        <h2>Snacks Deleted Successfully</h2>
        <%
                    } else {
        %>
                        <h2>Failed to Delete Snacks</h2>
        <%                        
                    }
        ...
        %>
                <h2>No snacks ID provided for deletion.</h2>
        <%
            }
        %>
        <table border="1">
